...
export const Navigation = () => {
  ...
  return (
    <nav className="bg-[#fefefe] dark:bg-gray-800 shadow-md sticky top-0 z-50 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none transition-colors duration-300"
      ...
      {/* Mobile menu */}
      {isMenuOpen && (
        <div className="md:hidden bg-[#fefefe] dark:bg-gray-800 shadow-lg pb-4 transition-all duration-300">
